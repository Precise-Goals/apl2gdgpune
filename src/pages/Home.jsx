...
export default function Home({ isAuthenticated, onOpenAuth }) {
  return (
    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "100px 30px", boxSizing: "border-box" }}>
      ...
      <header style={{ marginBottom: "80px", maxWidth: "900px" }}>
        ...
        <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
          {isAuthenticated ? (
            <Link to="/agent" className="flat-btn flat-btn-primary" style={{ padding: "16px 32px", fontSize: "1rem" }}>
              Launch Workspace ✦
            </Link>
          ) : (
            <button 
          ...
          <Link to="/docs" className="flat-btn" style={{ padding: "16px 32px", fontSize: "1rem" }}>
      ...
      <div style={{ marginTop: "120px", padding: "50px", border: "1px solid var(--text-charcoal)", background: "var(--sand-light)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "30px" }}>
        ...
        <Link to="/about" className="flat-btn flat-btn-primary" style={{ padding: "14px 28px" }}>
