...
export default function About({ isAuthenticated, onOpenAuth, profile, handleLogout }) {
  return (
    <PageLayout
    ...
    >
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "80px 30px", boxSizing: "border-box" }}>
